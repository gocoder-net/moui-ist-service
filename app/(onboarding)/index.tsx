...
function SelectionCard({
  ...
  const cardAnim = useAnimatedStyle(() => ({
    ...
    backgroundColor: interpolateColor(borderProgress.value, [0, 1], [C.white, '#FDFBF7']),
  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={StyleSheet.absoluteFill} pointerEvents="none">
        ...
        <FloatingShape shape="ring" size={160} color={C.goldLight} opacity={0.06} top="50%" left="55%" duration={7000} delay={800} />
        <FloatingShape shape="ring" size={80} color={C.gold} opacity={0.08} top="80%" left="8%" duration={5000} delay={400} />
