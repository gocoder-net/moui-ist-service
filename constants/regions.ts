...
/** 시/도 목록 (순서) */
export const PROVINCE_LIST = Object.keys(REGIONS);

/** "서울특별시 강남구" → { province: "서울특별시", district: "강남구" } */
export function parseRegion(region: string | null | undefined): { province: string; district: string } | null {
